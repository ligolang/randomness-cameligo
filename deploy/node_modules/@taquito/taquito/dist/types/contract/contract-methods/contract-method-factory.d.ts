...
export declare class ContractMethodFactory<T extends ContractProvider | Wallet> {
    ...
    createContractViewObjectParam(rpc: RpcClientInterface, smartContractViewSchema: ViewSchema, contractStorageType: MichelsonV1Expression, contractStorageValue: MichelsonV1Expression, viewArgs: any): OnChainView;
}
